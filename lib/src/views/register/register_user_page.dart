...
import 'package:crudweb/src/views/register/componentes/register_user.dart';
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => RegisterUser(user: user)));
                      }, 
